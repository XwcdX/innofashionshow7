        ...
        <>
            <div className="main-layout-background flex items-center justify-center w-screen h-screen overflow-hidden font-neue-montreal">
                <div className="flex items-center justify-center w-full h-full p-4">
                    <div className="w-full max-w-xs sm:max-w-sm md:max-w-md p-8 md:p-10 rounded-2xl md:rounded-3xl bg-black/20 backdrop-blur-xl shadow-2xl shadow-purple-900/30 border border-white/20 flex flex-col justify-center items-center text-center space-y-8 md:space-y-10">
