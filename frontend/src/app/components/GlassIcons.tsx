...
const gradientMapping: Record<string, string> = {
  blue: "linear-gradient(hsl(243, 63.10%, 27.60%), hsl(223, 81.90%, 32.50%))",
  purple: "linear-gradient(hsl(283, 90%, 50%), hsl(268, 90%, 50%))",
  red: "linear-gradient(hsl(332, 62.20%, 36.30%), hsl(322, 64.60%, 46.50%))",
  indigo: "linear-gradient(hsl(185, 89.80%, 50.00%), hsl(172, 89.80%, 50.00%))",
  orange: "linear-gradient(hsl(0, 0.00%, 0.00%), hsl(30, 12.10%, 12.90%))",
  green: "linear-gradient(hsl(106, 98.10%, 58.40%), hsl(108, 90%, 40%))",
};
