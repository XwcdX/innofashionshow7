        ...
        <div className="flex flex-col items-center justify-center min-h-[60vh] p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-xl">
                ...
                >
                    ...
                    {/* <img src="/path/to/intermediate-image.jpg" alt="Intermediate" className="absolute inset-0 w-full h-full object-cover opacity-50 group-hover:opacity-70 transition-opacity duration-300"/> */}
                ...
                >
                    {/* Replace with actual image if desired */}
                     {/* <img src="/path/to/advanced-image.jpg" alt="Advanced" className="absolute inset-0 w-full h-full object-cover opacity-50 group-hover:opacity-70 transition-opacity duration-300"/> */}
                    <div className="absolute inset-0 bg-black bg-opacity-40 group-hover:bg-opacity-30 transition-opacity duration-300"></div>
                    <div className="relative flex items-center justify-center h-full">
    ...
    return (
        <div className="min-h-screen py-8 px-4 relative z-10">
            {!selectedCategory ? (
                ...
                <>
                    {/* Display selected category with reset button */}
                    <div className="max-w-2xl mx-auto mb-4 p-4 bg-indigo-100 border border-indigo-300 rounded-md flex justify-between items-center shadow-sm">
