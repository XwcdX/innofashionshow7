...
export default async function handler(
    ...
    if (!token) {
        console.warn(`[Creation] submission attempt without auth token cookie.`);
    ...
    const backendUrl = getBackendUrl(`/${registrationType}/submitCreation`);
    ...
    try {
        ...
        console.log(`Backend [Creation] submission response status: ${apiRes.status}`);
        ...
        console.error(`Error forwarding submission request for [Creation] to backend:`, error);
