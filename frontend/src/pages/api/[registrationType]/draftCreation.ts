...
export default async function draftHandler(req: NextApiRequest, res: NextApiResponse) {
    ...
    const backendUrl = getBackendUrl(`/contest/draftCreation`);
    ...
    try {
        ...
        console.log(`Backend [Creation] draft response status: ${apiRes.status}`);
        ...
        console.error(`Error forwarding draft request for [Creation] to backend:`, error);
